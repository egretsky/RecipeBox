...
// Function to send a POST request to the '/auth/signup' endpoint with user signup information
...
export { login, signup };  // Export the login and signup function to be used elsewhere in the application
